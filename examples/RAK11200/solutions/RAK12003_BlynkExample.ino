...
#define BLYNK_TEMPLATE_ID "TMPLd81_kfDC"
...
char auth[] = ""; //this is provided on your template

// Your WiFi credentials.
// Set password to "" for open networks.
char ssid[] = ""; //your network credentials
char pass[] = ""; //your network credentials
...
void myTimerEvent()
{
  ...
  Blynk.virtualWrite(V5, objectTemp());
}
